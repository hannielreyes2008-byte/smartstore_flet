...
* `smartstore_flet` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `smartstore_flet` - executable or bundle name on disk.
* `smartstore_flet` - display name shown in window titles and about app dialogs.
